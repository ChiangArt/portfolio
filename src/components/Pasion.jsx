        ...
        <div className="flex flex-col gap-12 lg:gap-28 lg:flex-row p-7 overflow-hidden mt-6">
          ...
          <div className="flex flex-col gap-7 lg:w-1/3 items-center">
            <div className="flex justify-center items-center w-40 h-40 bg-amber-400 rounded-full lg:mb-10">
              <ComputerDesktopIcon className="w-28 h-28 transition-transform duration-300 hover:scale-110" />
            </div>
          ...
          <div className="flex flex-col gap-7 lg:w-1/3 items-center">
            <div className="flex justify-center items-center w-40 h-40 bg-amber-400 rounded-full lg:mb-10">
              <CodeBracketIcon className="w-28 h-28 transition-transform duration-300 hover:scale-110" />
            </div>
          ...
          <div className="flex flex-col gap-7 lg:w-1/3 items-center">
            <div className="flex justify-center items-center w-40 h-40 bg-amber-400 rounded-full lg:mb-10">
              <LightBulbIcon className="w-28 h-28 transition-transform duration-300 hover:scale-110" />
            </div>
